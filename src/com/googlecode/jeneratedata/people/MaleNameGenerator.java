 ...
 */
public class MaleNameGenerator implements Generator<String> {
	/**
	 * Array of the most common male names in the United States.
	 */
	private String[] names = new String[] { "James", "John", "Robert",
